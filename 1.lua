...
WindUI:Popup({
    Title = CreateGradientText("Nero Script MM2", Colors.Red, Colors.Green),
    Icon = "skull",
    Content = CreateGradientText("Best MM2 Script!", Colors.Gold, Colors.Blue) 
        .. "<br/>" 
    ...
    Buttons = {
        ...
        },
        {
            Title = "Copy Discord",
            Callback = function()
                setclipboard("https://discord.gg/PJJ65Kymwh")
                WindUI:Notify({
...
local Window = WindUI:CreateWindow({
    Title = CreateGradientText("Nero Script | Murder Mystery 2", Colors.Red, Colors.Green),
    Author = "by https://discord.gg/PJJ65Kymwh ",
    Folder = "Kuni Hb",
    Icon = "skull",
    NewElements = true,
...
local function FlingPlayers(playerNames)
    ...
    local function FlingPlayer(targetPlayer)
        ...
        -- Perform fling on appropriate part
...
local function FindNearestCandy()
    ...
    -- Fallback: search for "candy" named parts
...
-- Auto Resume Farming on Round Start
if RoundStartRemote then
    RoundStartRemote.OnClientEvent:Connect(function()
        candyCollected = 0
        collectedItems = {}
        ...
        -- Resume candy autofarm if it was enabled
        if candyAutofarmEnabled then
        ...
        -- Resume coin autofarm if it was enabled
...
-- Check if weapon name matches (helper for visual weapons)
...
local function FindGunDrops()
    ...
    -- Check for gun drop in main workspace
...
local MainSection = Window:Section({
    Title = CreateGradientText("Nero Script", Colors.Pumpkin, Colors.Purple),
    Icon = "flame",
    Opened = true,
})
...
InfoTab:Section({
    Title = "Best MM2 script with comprehensive features including ESP, auto-farming, weapon duplication, role-specific functions, and much more! Perfect for Murder Mystery 2 players looking for an edge.",
    TextSize = 16,
    TextTransparency = 0.3,
    FontWeight = Enum.FontWeight.Medium,
})
